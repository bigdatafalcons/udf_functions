package Common_floor.Common_floor;
...
public class commonfloor_Amenities extends EvalFunc<String>  
{
	...
	public String amenities(String input) {
		...
		if(StringUtils.containsIgnoreCase(input, "Gym"))
			dummies = dummies + "	1";
		else 
			dummies = dummies + "	0";
		...
		if(StringUtils.containsIgnoreCase(input, "Gas Pipeline"))
			dummies = dummies + "	1";
		else 
			dummies = dummies + "	0";
		...
		if(StringUtils.containsIgnoreCase(input, "Garden"))
			dummies = dummies + "	1";
		else 
			dummies = dummies + "	0";
		
		if(StringUtils.containsIgnoreCase(input, "Water Supply"))
			dummies = dummies + "	1";
		else 
			dummies = dummies + "	0";
		...
		if(StringUtils.containsIgnoreCase(input, "Reserved"))
			dummies = dummies + "	1";
		else 
			dummies = dummies + "	0";
		...
		if(StringUtils.containsIgnoreCase(input, "Kids Play Area"))
			dummies = dummies + "	1";
		else 
			dummies = dummies + "	0";
		if(StringUtils.containsIgnoreCase(input, "Sports Facility"))
			dummies = dummies + "	1";
		else 
			dummies = dummies + "	0";
		if(StringUtils.containsIgnoreCase(input, "Gated Community"))
			dummies = dummies + "	1";
		else 
			dummies = dummies + "	0";
